            ...
            <main>
                ...
                <div class="container margin_60_35">
                    <div class="main_title_3">
                        ...
                        <a href="all-categories">View all</a>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-6">
                            <a href="grid-listings-filterstop" class="grid_item">
                                <figure>
                        ...
                        <div id="reccomended" class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="review_listing">
                                    ...
                                    <h3><strong>Jhon Doe</strong> reviewed <a href="reviews-page">Fnac</a></h3>
                            ...
                            <div class="item">
                                <div class="review_listing">
                                    ...
                                    <h3><strong>Marika</strong> reviewed <a href="reviews-page">Fnac</a></h3>
                            ...
                            <div class="item">
                                <div class="review_listing">
                                    ...
                                    <h3><strong>Lukas Lee</strong> reviewed <a href="reviews-page">Fnac</a></h3>
                            ...
                            <div class="item">
                                <div class="review_listing">
                                    ...
                                    <h3><strong>Margaret</strong> reviewed <a href="reviews-page">Fnac</a></h3>
                                    <h4>"Perfect"</h4>
                                    <p>Et nec tantas accusamus salutatus, sit commodo veritus te</p>
                                    <ul class="clearfix">
                                        <li><small>Published: 26.08.2018</small></li>
                            ...
                            <div class="item">
                                <div class="review_listing">
                                    ...
                                    <h3><strong>Mark Twain</strong> reviewed <a href="reviews-page">Fnac</a></h3>
                    ...
                    <div class="wrapper">
                        <div class="container clearfix">
                            <div class="col-lg-5 col-md-7 float-right">
                                ...
                                <p><a class="btn_1 add_top_10 wow bounceIn" href="pricing" data-wow-delay="0.5s">Join Vanno Now!</a></p>
                            </div>
                        </div>
                        <!-- /container -->
                    </div>
