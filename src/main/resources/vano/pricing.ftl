...
<body class="bg_color_1">
    ...
    <div id="page">
        ...
        <header class="header menu_fixed">
            ...
            <ul id="top_menu">
                <li><a href="register" class="btn_top">Create a Free Account</a></li>
        ...
        <main class="bg_color_1">
            ...
            <div class="container margin_tabs">
                <div id="tabs" class="tabs">
                    <nav>
                        <ul>
                            <li><a href="#section-1"><i class="pe-7s-paper-plane"></i>Standard<em>Omnis justo gloriatur
                                        et sit</em></a></li>
                            <li><a href="#section-2"><i class="pe-7s-plane"></i>Extended<em>Quo corrumpit euripidis</em></a></li>
                            <li><a href="#section-3"><i class="pe-7s-rocket"></i>Premium<em>Constituto deterruisset</em></a></li>
                        </ul>
                    </nav>
                    <div class="content">
                        ...
                        <section id="section-2">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="box_pricing">
                                        <h4>1 Month</h4>
                                        <p>Diam timeam iracundia eu per, vide error id nec, est veniam equidem nonumes
                                            in. Has offendit oportere ea. Errem denique corpora ut vis, veniam fierent
                                            recteque vim no, in oblique forensibus accommodare cum.</p>
                                        <ul>
                                            <li><strong>Lorem</strong> consulatu qui ne</li>
                                            <li><strong>Erat legere</strong> fabulas has ut</li>
                                            <li><strong>Constituto</strong> deterruisset</li>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="box_pricing">
                                        ...
                                        <h4>1 Month</h4>
                                        <p>Iriure nostrud dignissim id vix, et velit soluta mei. Velit labore
                                            intellegat ad mel, ullum nobis quo in, rebum nihil malorum vix ex.</p>
                                        <ul>
                                            <li><strong>Lorem</strong> consulatu qui ne</li>
                                            <li><strong>Erat legere</strong> fabulas has ut</li>
                                            <li><strong>Constituto</strong> deterruisset</li>
