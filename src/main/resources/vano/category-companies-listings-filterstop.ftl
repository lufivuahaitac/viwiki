			...
			<div class="isotope-wrapper">
					...
					<div class="row">
						<div class="col-md-9">
							<div class="company_info">
								<figure><a href="reviews-page"><img src="img/brands/1.png" alt=""></a></figure>
						...
						<div class="col-md-3">
							...
							<a href="reviews-page" class="btn_1 small">Read more</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="company_listing isotope-item high">
					<div class="row">
						<div class="col-md-9">
							<div class="company_info">
								<figure><a href="reviews-page"><img src="img/brands/2.png" alt=""></a></figure>
								<h3>Timberland</h3>
								<p>Tale tollit vocent quo ut. Eu vix menandri persequeris accommodare, nam ei virtute dissentiet. Nec prima indoctum ei, vis eu justo dictas tamquam...</p>
							</div>
						</div>
				...
				<div class="company_listing isotope-item low">
					<div class="row">
						<div class="col-md-9">
							<div class="company_info">
								<figure><a href="reviews-page"><img src="img/brands/3.png" alt=""></a></figure>
								<h3>Elite</h3>
								<p>Tale tollit vocent quo ut. Eu vix menandri persequeris accommodare, nam ei virtute dissentiet. Nec prima indoctum ei, vis eu justo dictas tamquam...</p>
							</div>
						</div>
				...
				<div class="company_listing isotope-item low">
					<div class="row">
						<div class="col-md-9">
							<div class="company_info">
								<figure><a href="reviews-page"><img src="img/brands/5.png" alt=""></a></figure>
								<h3>Williams</h3>
								<p>Tale tollit vocent quo ut. Eu vix menandri persequeris accommodare, nam ei virtute dissentiet. Nec prima indoctum ei, vis eu justo dictas tamquam...</p>
							</div>
						</div>
				...
				<div class="company_listing isotope-item high">
					<div class="row">
						<div class="col-md-9">
							<div class="company_info">
								<figure><a href="reviews-page"><img src="img/brands/6.png" alt=""></a></figure>
								<h3>Fairlane</h3>
								<p>Tale tollit vocent quo ut. Eu vix menandri persequeris accommodare, nam ei virtute dissentiet. Nec prima indoctum ei, vis eu justo dictas tamquam...</p>
							</div>
						</div>
				...
				<div class="company_listing isotope-item high">
					<div class="row">
						<div class="col-md-9">
							<div class="company_info">
								<figure><a href="reviews-page"><img src="img/brands/8.png" alt=""></a></figure>
