						...
						<li>
                            <div class="dropdown dropdown-user">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                        <li><a href="user-dashboard">My Reviews</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="box_general general_info">
						...
						<p><strong>Mucius doctus constituto pri at.</strong> At vix utinam corpora, ea oblique moderatius usu. Vix id viris consul honestatis, an constituto deterruisset consectetuer pro quo corrumpit euripidis...<br><strong><a href="faq">Rear more</a></strong></p>
						<hr>
						<h3>Post a review<i class="pe-7s-help1"></i></h3>
						<p>Dolor detraxit duo in, ei sea dicit reformidans. Mel te accumsan patrioque referrentur. Has causae perfecto ut, ex choro assueverit eum...<br><strong><a href="faq">Rear more</a></strong></p>
						<hr>
						<h3>Approve a review<i class="pe-7s-help1"></i></h3>
						<p>Sed ne prompta insolens mediocrem, omnium fierent sed an, quod vivendo mel in. Argumentum honestatis ad mel, cu vis quot utroque...<br><strong><a href="faq">Rear more</a></strong></p>
						<hr>
						<div class="text-center"><a href="faq" class="btn_1 small">View al Faq</a></div>
					</div>
				</div>
			</div>
			<!-- /row -->
