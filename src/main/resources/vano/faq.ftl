...
<body>
	...
	<div id="page" class="theia-exception">
		...
		<header class="header menu_fixed">
			...
			<ul id="top_menu">
				<li><a href="write-review" class="btn_top">Create a Free Account</a></li>
						...
						<div role="tablist" class="add_bottom_45 accordion_2" id="payment">
							<div class="card">
								...
								<div id="collapseOne_payment" class="collapse show" role="tabpanel" data-parent="#payment">
									<div class="card-body">
										<p>Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan
