				...
				<div class="row">
					<div class="col-lg-8">
						<div class="box_general write_review">
							...
							<p>Thêm thông tin kinh doanh của bạn vào form bên dưới. Thông tin này sẽ không xuất hiện cho tới khi được xác
								thực.</p>
							<form>
								...
								<div class="form-group">
									...
									<input ng-model="formData.businessName" id="businessName" name="businessName" class="form-control" type="text"
									 placeholder="Phòng khám Nha Khoa Văn Minh, Bác sĩ Nguyễn Văn Minh ..." required>
								</div>
								<div class="form-group">
									<label>Địa chỉ (*)</label>
								...
								<div class="form-group">
									...
									<textarea class="form-control" style="height: 180px;" placeholder="Giới thiệu" required></textarea>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="checkboxes float-left add_bottom_15 add_top_15">
										<label class="container_check">Bằng việc sử dụng Dịch vụ của chúng tôi, bạn đang đồng ý với các điều khoản
						...
						<div class="latest_review">
							...
							<div class="review_listing">
								<div class="clearfix add_bottom_10">
									...
									<span class="rating"><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i
