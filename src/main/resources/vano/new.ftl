...
<head>
    ...
    <meta name="description"
          content="Thêm thông tin về kinh doanh của bạn. Ví dụ: Cửa hàng, nhà hàng, khách sạn, phòng khám, bệnh viện ...">
                ...
                <div class="col-lg-9 col-12">
                    ...
                    <nav id="menu" class="main-menu">
                        <ul>
                            ...
                            <li class="d-block d-sm-none"><span><a href="#0" class="btn_top">Write a review</a></span>
                            </li>
                        </ul>
                    </nav>
                </div>
                    ...
                    <div class="box_general write_review">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <input ng-model="formData.businessName" id="businessName" name="businessName"
                                       class="form-control"
                                       type="text"
                                       placeholder="Phòng khám Nha Khoa Văn Minh, Bác sĩ Nguyễn Văn Minh ..."
                                       required>
                            </div>
                            <div class="form-group">
                                <label>Địa chỉ (*)</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="hours"><span class="weekday">Mon</span><span
                                            class="start">8:30 am</span><span>-</span><span
                                ...
                                <div class="row" id="work_hour">
                                    ...
                                    <div class="col-lg-2">
                                        <button type="button" value="submit" class="button btn_1"><span>Thêm</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="businessInfo" id="businessInfo" class="form-control"
                                          style="height: 180px;"
